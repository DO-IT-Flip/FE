...
import {
  ...
  COLOR_KEYS,
} from "../../../../../assets/styles/tag_color/tag_color";

import { COLORS as GRAY_COLORS } from "../../../../../assets/styles/gray_color/gray_color";
import ColorPaletteButton from "@/components/Button/ColorPaletteButton";
...
export default function TagColorPickerModal({
  onClose,
  onSelect,
  selectedColor,
}: TagColorPickerModalProps) {
  return (
    <div
      style={{
        position: "fixed",
    ...
    >
      ...
      >
        ...
        >
          ...
          <FiX
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.color = GRAY_COLORS.gray2)
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.color = GRAY_COLORS.gray4)
            }
          />
                 {" "}
        </button>
      ...
      >
               {" "}
        {COLOR_KEYS.map((tagKey) => {
          const hex = TAG_COLORS[tagKey];
